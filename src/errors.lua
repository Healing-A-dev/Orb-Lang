...
function error.new(type,line,...)
    ...
    local errors = {
		...
		ARRAY_EOL = "Orb: <syntax> error\ntraceback\n    [orb]: syntax error near '"..data[1].."' |> ',' expected, got "..data[2].."\n    [file]: "..arg[1].."\n    [line]: "..line,
		VALUE_EXPECTED = "Orb: <syntax> error\ntraceback\n    [orb]: syntax error near '"..data[1].."' |> value expected, got null\n    [file]: "..arg[1].."\n    [line]: "..line,
		LIB_LOCATION = "Orb: <FIXME> error\ntraceback\n    [orb]: unknown library location '"..data[1].."'\n    [file]: "..arg[1].."\n    [line]: "..line,
		LIB_NAME = "Orb: <FIXME> error\ntraceback\n    [orb]: attempting to use unknown library '"..data[1].."'\n    [file]: "..arg[1].."\n    [line]: "..line,
	}
