...
if #arg > 0 then
    ...
    if COMPILER.FLAGS.WARNALL then
        io.write("\nCompilation completed <\027[95m"..os.time() - start_time .."s\027[0m> with warning(s):\n  |> \027[2mXohe: " .. A .. "\n  |> \027[2mXohe: " .. LOAD .. "\n  |> \027[2mLexer: " .. L .. "\n  |> \027[2mParser: " .. P .. "\n  |> \027[2mCompiler: " .. C .. "\n\027[0m")
    elseif not COMPILER.FLAGS.WARN and not COMPILER.FLAGS.EXECUTE and not COMPILER.FLAGS.VMTF and not COMPILER.FLAGS.SILENT then
